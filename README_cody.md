...
02/18 vid2vid 다 지우고 다시 시작한다
02/18 코드 살짝 고치고 card 데이터로 학습 시키는중
02/18 내일 할 커리큘럼 발표 준비

02/19 머신러닝 커리큘럼 발표
02/19 vid2vid 테스트 코드는 돌아가나 결과가 이상하게 나옴.
02/19 option 바꿔서 다시 테스트
02/19 card 데이터셋으로 테스트 성공
02/19 태양 데이터셋으로 학습시키고 퇴근
